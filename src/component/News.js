...
export default class News extends Component {
    ...
    // nextPage = async()=>{
    //     let url=`https://newsdata.io/api/1/news?apikey=pub_137753f27179f7ab91a9728dd82a2130c71cf&category=${this.props.category}&language=en&country=${this.props.country}&page=${this.state.page+1}`
    //     window.scrollTo({
    //         top: 0, 
    //         behavior: 'auto'
    //     });
